...
class ErsMultiSheetExport implements WithMultipleSheets
{
    /**
    ...
    public function sheets(): array
    {
        ...
        if(count($regCourse) != 0)
        {
            ...
            foreach($regCourse as $v)
            {
                ...
                $sheets[] = new CourseExport($this->request,$v->id,$v->reg_course_title,$v->reg_course_code,$v->course_id,$this->department,$this->faculty);
            }
