    ...
    $("#fos").change(function () {
        ...
        $.getJSON("/sfos/" + id, function (data, status) {
            ...
            if (data == "") {
                ...
                $d.append(
                    '<option value="0">No Specialization for this level</option>'
                );
    ...
    $("#fos_id").change(function () {
        ...
        $.getJSON("/getFosPara/" + id, function (data, status) {
            ...
            if (
                ...
                if (dd == 5) {
                    var dr = Number(data.duration) + 1;
                    dd = dd + 1;
                } else {
                    var dr = Number(data.duration);
                }
            } else {
                if (dd == 4) {
            ...
            for (var i = 1; i <= dr; i++) {
                if (i < dd) {
                    if (
                        (id == fosIDMEDICINE && i > 2) ||
                        (id == fosIDDENTISTRY && i > 2) ||
                        (id == fosIDMEDICINEDE && i > 2) ||
                        (id == fosIDDENTISTRYDE && i > 2)
                    ) {
                        var part = i - 2;
                        $l.append(
                            '<option value="' +
            ...
            if (
                (pg == 3 && id == fosIDMEDICINE) ||
                (pg == 3 && id == fosIDDENTISTRY)
            ) {
                $rt.append(
                ...
                $rt.append(
                    '<option value="' +
                        8 +
                        '">Correctional Name Result </option>'
                );
            } else if (pg == 3) {
                $rt.append(
                    '<option value="' + 1 + '">Sessional Result</option>'
                ...
                $rt.append('<option value="' + 9 + '">Mop Up Result </option>');
                $rt.append('<option value="' + 14 + '">Delay Result</option>');
            } else if (pg == 2) {
                $rt.append(
                ...
                $rt.append(
                    '<option value="' + 13 + '">Correctional Result </option>'
                );
                $rt.append(
                    '<option value="' +
                        6 +
