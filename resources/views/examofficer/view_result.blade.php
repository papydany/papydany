        ...
        <div class="col-sm-12" style="min-height: 300px;">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/v_result') }}" data-parsley-validate>
                        {{ csrf_field() }}
...
@if(isset($c))
                  ...
                  ->where('semester_id',$sm)->first()}}
                      ...
                      <form class="form-horizontal" role="form" method="POST" action="{{ url('/d_result') }}" target="_blank" data-parsley-validate>
                    {{ csrf_field() }}
                  <div class="form-group">
                  <label for="level" class=" control-label">Course</label>
                     ...
                     <option value="">-- select --</option>
                      ...
                      }}">{{$v->reg_course_code}} = {{$v->reg_course_status}}</option>
                      @endforeach
                         </optgroup>
                      @endforeach
                     </select>
...
<div class="col-sm-12">
                  <div class="panel panel-default">
                <div class="panel-heading">Download Result</div>
                <div class="panel-body">
                  <h4 class="text-danger">
                    Before click these button below, be sure all grade entered are correct.
                    Once you click on the download for sbc approval all grade entered are sealed.
                  </h4>
                  <p class="text-danger">Reversible Only by the DVC</p>

                                <input type="submit" class="btn btn-primary btn-block" value="Download For SBC Approval" name="sbc"
                                   />
