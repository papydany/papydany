...
$elective_grade2 = $R->fetch_electives($v->id,$s,$l,2,$season,$electiveSql2);
 ...
 $repeat_course =$R->repeat_summer_course($v->id,$s,$l);
...
//dd();
$remark =$R->result_check_pass_sessional($l,$v->id,$s,$cgpa,$season,$fos,'',$failResult['sum_of_F'],
$courseWithResult,$rccnirq,$totalElective,$passedVacationCourseId);
...
echo '<td class="s9">',$R->getDropCourse($v->id,$l,$s,$fos,$season,$f),'</td>';
