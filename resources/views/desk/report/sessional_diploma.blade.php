  ...
  <div class="row" style="min-height: 520px;padding-left: 0px; padding-right: 0px;">
     <div class="col-sm-12">
                   ...
                   <?php   $dname = $R->get_departmetname($d);
                      ...
                      $reg_course_elective_id1 =$R->getRegisteredCourseElective($s,$l,1,$fos->id);
                      $reg_course_elective_id2 =$R->getRegisteredCourseElective($s,$l,2,$fos->id);
  ...
  /*if( $special ){
   ...
   // $set['class'] = array(0=>'', 1=>'', 2=>'');
    ...
    $set['bottom'] = '<p style="margin-left:0px">
              ...
              <span style="color:#000; padding-left:3px"></span>
              <span style="color:#000; padding-left:3px"></span>
              <span style="color:#000; padding-left:3px; font-size:10px;" class="B">(DIRECTOR OF '.strtoupper($fname).')</span>
              <span style="color:#000; padding:20px 0 0 3px; font-size:10px;">DATE: .............................................................</span>
            </p>
            <p> 
...
$remark = $R->result_check_pass_sessional_diploma($l,$v->id,$s,$season,$courseWithResult,$rccnirq);
...
for($i=0; $i<$k; $i++) {
         ...
         if( $final !='' ) {
          $ignore = substr($remark,0,4) == 'PASS' ? false : true;
              ...
              echo '<td class="B tc">',$R->D_degree($cgpa, $ignore),'</td>';
            }
