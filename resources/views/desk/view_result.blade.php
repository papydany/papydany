        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/view_result') }}" data-parsley-validate>
                        {{ csrf_field() }}
...
@if(isset($c))
                  ...
                  ->where('semester_id',$sm)->first()}}
                      ...
                      <form class="form-horizontal" role="form" method="POST" action="{{ url('/view_result_detail') }}" data-parsley-validate target="_blank">
                    {{ csrf_field() }}
                  <div class="form-group">
