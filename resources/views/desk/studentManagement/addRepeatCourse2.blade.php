    ...
    <div class="row" style="min-height: 520px;">
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">Add Repeat Courses</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="GET" action="{{ url('getStudentManagementAddRepeatCourse2') }}"  data-parsley-validate>
                        {{ csrf_field() }}
                        <div class="form-group">
                     <div class="col-sm-2">
                              <label for="level" class=" control-label">Previous Two Level</label>
                            ...
                            @else
                               <div class="col-sm-2">
                              <label for="session" class=" control-label">Previous Two Session</label>
                              <select class="form-control" name="session_id" required>
                              <option value=""> - - Select - -</option>
     ...
     <form class="form-horizontal" role="form" method="POST" action="{{ url('postStudentManagementAddRepeatCourse2') }}" data-parsley-validate>
                        {{ csrf_field() }}
