...
@section('content')
 <!-- Page Heading -->
    ...
    <div class="row" style="min-height: 520px;">
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="GET" action="{{ url('getStudentManagementAddRepeatCourse') }}"  data-parsley-validate>
                        {{ csrf_field() }}
     ...
     <form class="form-horizontal" role="form" method="POST" action="{{ url('postStudentManagementAddRepeatCourse') }}" data-parsley-validate>
                        {{ csrf_field() }}
