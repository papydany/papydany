...
@section('content')
 <!-- Page Heading -->
    ...
    <?php $result=session('key');?>
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="GET" action="{{ url('getStudentManagementAddCarryOverCourse2') }}"  data-parsley-validate>
                        {{ csrf_field() }}
     ...
     <form class="form-horizontal" role="form" method="POST" action="{{ url('postStudentManagementAddCarryOverCourse2') }}" data-parsley-validate>
                        {{ csrf_field() }}
