    ...
    <div class="row" style="min-height: 520px;">
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">SetUp Graduation List</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="GET" action="{{ url('setupGraduate1') }}" target="_blank" data-parsley-validate>
                        {{ csrf_field() }}
...
<div class="form-group">
  ...
  <input type="hidden" name="approval" value="2">
                       ...
                       <div class="col-sm-3">
                              ...
                              <select class="form-control" name="department_id" id="department_idg" required>
                             </select>
                            ...
                            <div class="col-sm-3">
                                 <label for="faculty">Field Of Study</label>
                                  <select class="form-control" name="fos" id="fos_idg" required>
                             </select>
                                </div>
                                 <div class="col-sm-3">
